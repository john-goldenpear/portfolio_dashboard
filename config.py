...
DYDXV3_API_KEY_1= os.getenv('DYDXV3_API_KEY_1')
DYDXV3_API_SECRET_1 = os.getenv('DYDXV3_API_SECRET_1')
DYDXV3_API_PASSPHRASE_1 = os.getenv('DYDXV3_API_PASSPHRASE_1')
DYDXV3_API_KEY_2 = os.getenv('DYDXV3_API_KEY_2')
DYDXV3_API_SECRET_2 = os.getenv('DYDXV3_API_SECRET_2')
DYDXV3_API_PASSPHRASE_2 = os.getenv('DYDXV3_API_PASSPHRASE_2')
